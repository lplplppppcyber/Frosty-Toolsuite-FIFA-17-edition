...
{
    public partial class DuplicateFolderWindow : FrostyDockableWindow
    {
        ...
        public DuplicateFolderWindow(string inSourceFolder)
        {
            InitializeComponent();
        ...
        private void DuplicateButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                FrostyMessageBox.Show("New folder name cannot be empty.", "Folder Duplicator");
                return;
            }

            if (newName.Contains("//") || newName.Contains(" "))
            {
                FrostyMessageBox.Show("Name contains invalid characters (no spaces or double slashes).", "Folder Duplicator");
                return;
            }
            ...
            {
                FrostyMessageBox.Show("New name must be different from the source.", "Folder Duplicator");
                return;
            }
            ...
            {
                FrostyMessageBox.Show("Select a destination folder in the tree.", "Folder Duplicator");
                return;
            }
